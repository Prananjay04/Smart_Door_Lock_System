...
Window window;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT>=21)
        {
            ...
            window.setStatusBarColor(this.getResources().getColor(R.color.Cyan));
        }
        if (actionBar !=null)
        {
            actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.custom3));
        }
...
//	String c=session.getAttribute("che").toString();
